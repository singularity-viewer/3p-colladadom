...
protected:
	 ...
	 * Overloaded assignment operator
	 */
	domFx_sampler3D_common_complexType &operator=(const domFx_sampler3D_common_complexType&) { return *this; }
};
...
protected:
	 ...
	 * Overloaded assignment operator
	 */
	domFx_sampler3D_common &operator=(const domFx_sampler3D_common&) { return *this; }
